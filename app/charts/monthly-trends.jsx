                ...
                {hasData ? (
                    ...
                    <View style={{
                        ...
                        <Text style={{
                            ...
                            There are no monthly trends for the past {getTimeframeLabel(selectedTimeframe)}. Try selecting a longer date range or log some workouts to start tracking monthly patterns.
                        </Text>
                    </View>
                )}
            </ScrollView>
