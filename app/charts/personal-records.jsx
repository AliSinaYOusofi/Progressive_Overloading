                ...
                {hasData ? (
                    ...
                    <View style={{
                        ...
                        <Text style={{
                            ...
                            There are no personal records for the past {getTimeframeLabel(selectedTimeframe)}. Try selecting a longer date range or log some workouts to start tracking your PRs.
                        </Text>
                    </View>
                )}
            </ScrollView>
