...
import { ArrowUpDown, TrendingUp, Dumbbell, Type, ArrowUp, ArrowDown, Database } from 'lucide-react-native';
...
const SORT_OPTIONS = [
  ...
  { 
    ...
    icon: TrendingUp,
    orders: [
      { id: 'desc', label: 'Best Progress First', icon: ArrowDown },
      { id: 'asc', label: 'Worst Progress First', icon: ArrowUp },
    ]
  },
  { 
    id: 'records', 
    ...
    icon: Database,
    orders: [
      { id: 'desc', label: 'Most Records First', icon: ArrowDown },
      { id: 'asc', label: 'Least Records First', icon: ArrowUp },
    ]
  },
];

export default function ExerciseProgressionFilterModal({ 
  visible, 
  onClose, 
  sortBy, 
  sortOrder, 
