...
import { ArrowUpDown, Type, TrendingUp, Activity, Dumbbell, ArrowUp, ArrowDown } from 'lucide-react-native';
...
const SORT_OPTIONS = [
  ...
  { 
    ...
    icon: Activity,
    orders: [
      { id: 'desc', label: 'Best First', icon: ArrowDown },
      { id: 'asc', label: 'Worst First', icon: ArrowUp },
    ]
  },
  { 
    id: 'workoutCount', 
...
export default function ProgressiveOverloadFilterModal({ 
  visible, 
  onClose, 
  sortBy, 
  sortOrder, 
