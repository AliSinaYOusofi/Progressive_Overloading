...
import { ArrowUpDown, Trophy, Dumbbell, Type, ArrowUp, ArrowDown, Calendar } from 'lucide-react-native';
...
const SORT_OPTIONS = [
  ...
  { 
    ...
    icon: Dumbbell,
    orders: [
      { id: 'desc', label: 'Heaviest First', icon: ArrowDown },
      { id: 'asc', label: 'Lightest First', icon: ArrowUp },
    ]
  },
  { 
    id: 'date', 
...
export default function PersonalRecordsFilterModal({ 
  visible, 
  onClose, 
  sortBy, 
  sortOrder, 
