...
import { ArrowUpDown, Calendar, Activity, Dumbbell, Repeat, ArrowUp, ArrowDown } from 'lucide-react-native';
...
const SORT_OPTIONS = [
  { 
    ...
    icon: Calendar,
    orders: [
      { id: 'desc', label: 'Most Recent First', icon: ArrowDown },
  ...
  { 
    ...
    icon: Repeat,
    orders: [
      { id: 'desc', label: 'Most Sets First', icon: ArrowDown },
      { id: 'asc', label: 'Least Sets First', icon: ArrowUp },
    ]
  },
  { 
    id: 'exercises', 
    ...
    icon: Dumbbell,
    orders: [
      { id: 'desc', label: 'Most Exercises First', icon: ArrowDown },
      { id: 'asc', label: 'Least Exercises First', icon: ArrowUp },
    ]
  },
];

export default function MonthlyTrendsFilterModal({ 
  visible, 
  onClose, 
  sortBy, 
  sortOrder, 
